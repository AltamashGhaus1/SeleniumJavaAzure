package com.jdbc.automation.executor.mcube4530.AdvanceAnalytics;
...
//            System.out.println("Clone is clicked");
            ...
            //driver.findElements(By.xpath("//select[@id='tables']/optgroup[@label='Table']/option[@label='admin_access']")))
