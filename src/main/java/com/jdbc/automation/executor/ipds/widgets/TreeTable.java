...
public class TreeTable {
    ...
    public static String treeTable(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        String temp="false";
        try {
            SeleniumUtils.yDataFill(driver, wait, "Tree");
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            SeleniumUtils.xDataFill(driver, wait, "Tree");
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            ...
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            //------------------------------------
            String expResult = driver.findElement(By.xpath("//*[@id=\"kibana-body\"]/div[1]/div/div/div[3]/visualize-app/kbn-top-nav/div/div/div/div[1]/div[1]/ol/li[4]/a")).getText().trim();
            ...
            screenShot.add(com.jdbc.automation.executor.ipds.Common.SeleniumUtils.takeScreenShot(driver));
            actualOutcome = false;
            ...
            com.jdbc.automation.executor.ipds.Common.SeleniumUtils.clickModal(driver, webEl);
            Thread.sleep(2000);
            log.error("",e);
        }
        finally {
