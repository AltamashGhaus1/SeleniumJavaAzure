package com.jdbc.automation.executor.ipds.Miscellaneous;
...
public class JoinDataset {
    ...
    public static String joinDataset(WebDriver driver, WebDriverWait wait, List<Records> listOb, String dataset) throws Exception {
        ...
        try {
            ...
            SeleniumUtils.query(driver, wait,dataset);

            screenShot.add(SeleniumUtils.takeScreenShot(driver));

            driver.findElement(By.className("btn-success")).click();

            System.out.println("Waiting for 30 seconds for JD Alert");
            Thread.sleep(30000);
            ...
            System.out.println("Wait for Modal xpath to be present ");
            //wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@class='ajs-button btn btn-danger']")));
            ...
            try {                                                   //*[@id=\"kibana-body\"]/div[2]/div[2]/div/div[4]/div[2]/button
                ...
                webElem = driver.findElement(By.xpath("//button[@class='ajs-button btn btn-danger']"));
                log.error("",e);
            }
        ...
        driver.findElement(By.className("ajs-button btn btn-danger")).click();*/
            ...
            List<WebElement> addDS = driver.findElements(By.cssSelector("button[class=\"ajs-button btn btn-danger\"]"));
            System.out.println("addDS size : "+addDS.size());
            try {                                                   //*[@id="kibana-body"]/div[84]/div[2]/div/div[4]/div[2]/button[2]
                //webElem2 = driver.findElement(By.xpath("//*[@id=\"kibana-body\"]/div[84]/div[2]/div/div[4]/div[2]/button[2]"));
                webElem2 = addDS.get(1);
            } catch (Exception e) {
                webElem2 = driver.findElement(By.xpath("//*[@id=\"kibana-body\"]/div[84]/div[2]/div/div[4]/div[2]/button[2]"));
                log.error("",e);
            }
            ...
            if (!actualOutcome) {
                System.out.println("Join Dataset creation failed.");
                return name;
            }
        }
        return name;
