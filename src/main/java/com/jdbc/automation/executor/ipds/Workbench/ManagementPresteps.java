...
public class ManagementPresteps {
    ...
    public static boolean managementPresteps(WebDriver driver, WebDriverWait wait, List<Records> listOb, String username, String password, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            SeleniumUtils.loginWB(driver, screenShot,username, password);
