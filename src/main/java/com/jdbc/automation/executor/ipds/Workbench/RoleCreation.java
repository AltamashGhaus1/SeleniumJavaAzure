...
public class RoleCreation {
    ...
    public static String roleCreation(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            Thread.sleep(2000);
            try {
                driver.findElement(By.xpath("//*[@id=\"tabs-1\"]/div[1]/button/div/i")).click();
            } catch (Exception e) {
            ...
            Thread.sleep(2000);
            try {
                driver.findElement(By.id("role-name")).click();
            } catch (Exception e) {
            ...
            //Save is clicked
            driver.findElement(By.xpath("//*[@id=\"tabs-1\"]/div[2]/div[2]/button")).click();
            ...
            if (flag == 1) {
                ...
                if (SeleniumUtils.isRoleCreated(driver, wait, roleName)) {
                    ...
                    WebElement webEl = driver.findElement(By.xpath("//*[@id=\"main\"]/nav/div/div/ul/div[1]"));
