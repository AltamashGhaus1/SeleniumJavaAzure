...
//        OutputStream out = new FileOutputStream((SrcFile));
    ...
    public static boolean verifyAAWorkflow2(WebDriver driver) {
        ...
        try {
            ...
            System.out.println("Waiting for node tick--->");
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("graph-node[class='graph-node-component ng-scope ng-isolate-scope jtk-draggable jtk-endpoint-anchor jtk-connected']")));
//            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("graph-node[class='graph-node-component ng-scope ng-isolate-scope jtk-draggable jtk-endpoint-anchor']")));
            System.out.println("Completed waiting for node tick--->");
...
//            List<WebElement> Weblist = driver.findElement(By.cssSelector("div[class='c-dynamic-part ng-scope']")).findElement(By.cssSelector("div[class='editor']")).findElement(By.cssSelector("div[class='flowchart-paint-area']")).findElements(By.cssSelector("graph-node[class='graph-node-component ng-scope ng-isolate-scope jtk-draggable jtk-endpoint-anchor']"));
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (sText1.contains("status-icon completed")) {
                    ...
                    flag = false;
                    System.out.println("FALSE --> in Node Tick");
                    return flag;
                }
            ...
            if (counter == size) {
                ...
                System.out.println("pass:- No. of nodes and checked status are equal -> flag : "+flag);
                return flag;
            } else {
                System.out.println("fail:- No. of nodes and checked status are not equal -> flag : "+flag);
                return flag;
            }
        }//end of try block
        catch (Exception e) {
        ...
        try {
            for (int i = 0; i < node.size(); i++) {
                ...
                if (i == 6 || i == 7) {
                    ...
                    detailsOutcome = detailsFilling(driver, wait, i, nodeName, screenShot);

                    System.out.println("detailsOutcome : " + detailsOutcome);
                    //continue;
                } else {
                    nodeName = node.get(i);
                    System.out.println(nodeName);
    ...
    public static boolean detailsFilling(WebDriver driver, WebDriverWait wait,int index,String nodeName, List<File> screenShot) throws Exception {
        ...
        if (nodeName.equals("Read Data")) {
            ...
            System.out.println("Clicked Read Data for data source entry");
            //driver.findElement(By.cssSelector("div[class='custom-name ng-binding ng-scope']")).findElement(By.cssSelector("span[class='ng-binding']")).click();
            //list


            //Search your profile name using list
            //Click om the first profile visible
            //Run already written
            ...
            System.out.println("Inside Split Node------->");
            ...
            Thread.sleep(2000);
            List<WebElement> list=driver.findElements(By.cssSelector("input[class='form-control ng-pristine ng-untouched ng-valid ng-scope ng-empty']"));
            //  list.get(0).sendKeys("0.8");

            System.out.println("List size: "+list.size());
            Thread.sleep(1000);

            List<WebElement> list1=driver.findElements(By.cssSelector("select[ng-model='choice']"));
            Select reportType = new Select(list1.get(1));
            reportType.selectByIndex(1);
            Thread.sleep(1000);

            SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-450,-120,5);
            flag=true;

        }
        else if (nodeName.equals("Logistic Regression")){

            System.out.println("Inside Logistic Regression Node------->");

            //SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-150,-120,7);

            SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-450,140,6);

            Thread.sleep(2000);
            System.out.println("Initial Success");

            WebElement drag1=driver.findElement(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable output estimator']")).findElement(By.tagName("svg"));

          /*String strText=drag1.getAttribute("position");
           System.out.println("Text Printed: "+strText);

           Point point = drag1.getLocation();
           ...
           j.executeScript("window.scrollBy(" + 696 + ", " + 386 + ");");
           System.out.println("scroll done"); */

            WebElement drop = driver.findElement(By.cssSelector("div[class='new-node-container']"));

            int width = drag1.getSize().getWidth();
            Actions act = new Actions(driver);

            act.moveToElement(drag1).moveByOffset((width/2)-2, 0).clickAndHold().moveToElement(drop).release().build().perform();

            Thread.sleep(1000);

            driver.findElement(By.cssSelector("div[class='new-node__input-container']")).findElement(By.tagName("input")).sendKeys("Train");
            ...
            SeleniumUtils.setOffsetDragAndDrop(driver,"Train",-150,-120,7);

            flag=true;
        }

        else if (nodeName.equals("Train")){

            System.out.println("Inside Train Node------->");

            // SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-150,-120,7);
            Thread.sleep(3000);

            List<WebElement>  drag1=driver.findElements(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable output transformer']"));

            System.out.println(drag1.size());
          ...
          /*String strText=drag1.getAttribute("position");
           ...
           System.out.println("scroll done"); */
            ...
            WebElement dragEl=drag1.get(3).findElement(By.tagName("svg"));

            WebElement drop = driver.findElement(By.cssSelector("div[class='new-node-container']"));

            int width = dragEl.getSize().getWidth();
            Actions act = new Actions(driver);
            Thread.sleep(1000);
            act.moveToElement(dragEl).moveByOffset((width/2)-2, 0).clickAndHold().moveToElement(drop).release().build().perform();

            Thread.sleep(1000);

            driver.findElement(By.cssSelector("div[class='new-node__input-container']")).findElement(By.tagName("input")).sendKeys("Transform/Predict");
            ...
            SeleniumUtils.setOffsetDragAndDrop(driver,"Transform/Predict",-10,-120,8);
        ...
        //------AG----------
            ...
            //SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,140,-250,8);
            ...
            SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-450,10,9);
            flag=true;
        }
            ...
            System.out.println("Node No inside SQL Transformation : "+nodeNo);
            ...
            try {
                WebElement area = driver.findElement(By.xpath("//div[@class='ace_scroller']"));
                //driver.findElement(By.xpath("//div[@class='ace_scroller']")).click();
                driver.findElement(By.xpath("//div[@class='ace_layer ace_gutter-layer ace_folding-enabled']")).click();
                //List<WebElement> queryWordList = driver.findElement(By.xpath("//div[@class='ace_line']")).findElements(By.tagName("span"));
                /*List<WebElement> queryWordList = driver.findElement(By.xpath("//div[@class='ace_scroller']/div/div[3]/div")).findElements(By.tagName("span"));
                System.out.println("queryWordList size : "+queryWordList.size());
                for(WebElement spanList : queryWordList) {
                    System.out.println("Clear i");
                    //spanList.clear();
                    String ctrlA = Keys.chord(Keys.CONTROL, "a",Keys.DELETE);
                    spanList.sendKeys(ctrlA);
                    String delA = Keys.chord(Keys.DELETE);
                    spanList.sendKeys(delA);
                }*/
            ...
            try {
                ...
                try {
                    /*driver.findElement(By.xpath("//div[@class='ace_layer ace_gutter-layer ace_folding-enabled']")).click();
                    WebElement webl = driver.findElement(By.xpath("//div[@class='ace_layer ace_gutter-layer ace_folding-enabled']"));
                    JavascriptExecutor js = (JavascriptExecutor)driver;
                    js.executeScript("arguments[0].value='Avinash Mishra';", webl);*/

                    //String text = "Hello World";
                    StringSelection stringSelection = new StringSelection(sqlData);
                ...
                //driver.findElement(By.xpath("//div[@class='ace_layer ace_gutter-layer ace_folding-enabled']")).sendKeys(sqlData);

                //driver.findElement(By.xpath("//div[@class='ace_line']")).sendKeys(sqlData);
            } catch (Exception e) {
                e.printStackTrace();
            ...
            SeleniumUtils.setOffsetDragAndDrop(driver,nodeName,-300,10,10);
            flag=true;
        }
        //-----AG-------------
    ...
    public static void setOffsetDragAndDrop(WebDriver driver, String nodeName, int x, int y, int nodeNo) throws InterruptedException {
        ...
        if(!nodeName.equals("Read Data") && !nodeName.equals("Handle Missing Values") && !nodeName.equals("Logistic Regression")) {
       ...
       /* else if (nodeName.equals("Logistic Regression")) {
            ...
            System.out.println("Inside LOG Reg and Node No : "+nodeNo);
            Thread.sleep(2000);


            WebElement drag1 = driver.findElement(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable output estimator']"));
            actions.moveToElement(drag1).perform();
            Thread.sleep(2000);
            WebElement newdrag1=driver.findElement(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable output estimator jtk-hover port-active']"));

            WebElement drop1 = driver.findElement(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable estimator']"));
            Thread.sleep(2000);

           //actions.moveToElement(drop1).build().perform();
           //WebElement newdrop1=driver.findElement(By.cssSelector("div[class='jtk-endpoint jtk-endpoint-anchor jtk-draggable jtk-droppable estimator jtk-hover port-active']"));

            actions.dragAndDrop(newdrag1, drop1).perform();
