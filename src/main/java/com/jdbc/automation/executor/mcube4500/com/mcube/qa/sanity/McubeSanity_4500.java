package com.jdbc.automation.executor.mcube4500.com.mcube.qa.sanity;

import com.jdbc.automation.executor.Common.Records;
import com.jdbc.automation.executor.mcube4500.AdvanceAnalytics.ArtificialIntelligence;
import com.jdbc.automation.executor.mcube4500.Common.SeleniumUtils;
import com.jdbc.automation.executor.mcube4500.Dashboard.Dashboard;
import com.jdbc.automation.executor.mcube4500.Explore.SavedSearch;
import com.jdbc.automation.executor.mcube4500.Miscellaneous.DataProfile;
import com.jdbc.automation.executor.mcube4500.Miscellaneous.DataUpload;
import com.jdbc.automation.executor.mcube4500.Miscellaneous.SavedObjects;
import com.jdbc.automation.executor.mcube4500.Workbench.ManagementPresteps;
import com.jdbc.automation.executor.mcube4500.Workbench.RoleCreation;
import com.jdbc.automation.executor.mcube4500.Workbench.UserCreation;
import com.jdbc.automation.executor.mcube4500.Workbench.WorkSpaceCreation;
import com.jdbc.automation.executor.mcube4500.com.mcube.qa.sanity.email.EmailSender;
import com.jdbc.automation.executor.mcube4500.com.mcube.qa.sanity.pdf.creator.PdfCreator;
import com.jdbc.automation.executor.mcube4500.widgets.AreaChart;
import com.jdbc.automation.executor.mcube4500.widgets.ComboChart;
import com.jdbc.automation.executor.mcube4500.widgets.PreStepsForWidget;
import com.jdbc.automation.executor.mcube4500.widgets.TreeTable;
...
public class McubeSanity_4500 {

    private static final Logger log= LoggerFactory.getLogger(McubeSanity_4500.class);
    ...
    public static File executeAutomation(String url, String username, String password, String dataset, String mailto, String createdBy, String createdByName, String client, String version, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            WebDriverWait waitLong = new WebDriverWait(driver, Duration.ofSeconds(300));
...
// --------------------------------- Check Version Start-------------------------------------------------------------------
            McubeSanity_4500 obj = new McubeSanity_4500();
...
// --------------------------------- ArtificialIntelligence Start-------------------------------------------------------
            ...
            ArtificialIntelligence.artificialIntelligence(driver, waitLong, listOb,clientVersionDao,san_aut_id);
