package com.jdbc.automation.executor.mcube4500.Workbench;
    ...
    public static boolean userCreation(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            */
            ...
            if(System.getenv("URL").equals("https://mcubeqa4500.tcgdigital.com/nxtgen")) {
            ...
            try {
                ...
                /*if(currentUrl.contains("https://mcubeqa4500.tcgdigital.com")) {
                    for (int i = 7; i < 10; i++) {
                        ...
                        if (i != 9) {                                //*[@id="tabs1"]/div[6]/div/form/div/div[9]/div[4]/span[1]/i
                ...
                } else if (currentUrl.contains("https://mcubeinqa451.tcgdigital.com")) {
                    {
                        for (int i = 8; i < 11; i++) {
