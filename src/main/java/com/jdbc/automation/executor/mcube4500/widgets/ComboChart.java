package com.jdbc.automation.executor.mcube4500.widgets;
...
public class ComboChart {
    ...
    public static String comboChart(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            screenShot.add(com.jdbc.automation.executor.mcube4500.Common.SeleniumUtils.takeScreenShot(driver));
            actualOutcome = false;
            ...
            com.jdbc.automation.executor.mcube4500.Common.SeleniumUtils.clickModal(driver, webEl);
            Thread.sleep(2000);
            log.error("",e);
        }
        finally {
