package com.jdbc.automation.executor.mcube4500.Common;
   ...
   /* public static void yDataFill(WebDriver driver, WebDriverWait wait, String widget) {
    ...
    public static void switchToWindow(int index, WebDriver driver) {
        ...
        try {
            ...
            System.out.println("Present window is closed");
        }
...
//        OutputStream out = new FileOutputStream((SrcFile));
    ...
    public static void dbConnection(WebDriver driver,String database,int index,String connectionName, List<File> screenShot) {
        ...
        try {
            ...
            //Thread.sleep(4000);
            driver.findElement(By.cssSelector("div[class='model-navigator']")).findElement(By.cssSelector("i[class='fa fa-database']")).click();
            Thread.sleep(2000);
            ...
            System.out.println("Connected or Not : "+str);

            Thread.sleep(8000);

            Select databaseDrpDwn = new Select(driver.findElement(By.cssSelector("select[id='database']")));
            databaseDrpDwn.selectByValue("string:gpadmin");

            Thread.sleep(5000);

            //Select tableDropdown = new Select(driver.findElement(By.cssSelector("select[id='tables']")));
            List<WebElement> tableDropdown = driver.findElement(By.cssSelector("select[id='tables']")).findElements(By.tagName("optgroup"));
            tableDropdown.get(0).findElement(By.cssSelector("option[value='string:sales_all_details_11']")).click();

            System.out.println("databaseDropdown: " + tableDropdown);

            //tableDropdown.selectByValue("string:sales_all_details_11");
    ...
    public static boolean checkVersion(WebDriver driver, WebDriverWait wait, List<Records> listOb, String className, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            if(className.contains("4520") && version.equals("Version: 4.5.2.0"))
                ...
                actualOutcome=true;
            else if(className.contains("4500") && version.equals("Version: 4.5"))
                actualOutcome=true;
