package com.jdbc.automation.executor.lummus4300.Common;
...
public class SeleniumUtils {
    ...
    public static void yDataFillTree(WebDriver driver, WebDriverWait wait, String widget) {
        //Add Metric click
        int j=0;
        for (int i = 2; i <= 13; i++) {
    ...
    public static void xDataFill(WebDriver driver, WebDriverWait wait, String widget) throws InterruptedException {
        ...
        int lenX = new Select(driver.findElement(By.id("3bucketSelectButtonID"))).getOptions().size();
        System.out.println("lenX : " + lenX);

        new Select(driver.findElement(By.id("3bucketSelectButtonID"))).selectByVisibleText("Terms");
        Thread.sleep(3000);
        //X Axis Field fill
        new Select(driver.findElement(By.id("3fieldSelectID"))).selectByVisibleText("City");
        Thread.sleep(3000);
        //X arrow button close
        driver.findElement(By.id("3metricExpandButtonIID")).click();
        // }
       /* else if(widget.equalsIgnoreCase("Area")) {
          ...
          //  driver.findElement(By.xpath("//*[@id=\"bucketButtonAddLabelID\"][2]")).click();
            ...
            new Select(driver.findElement(By.id("4bucketSelectButtonID"))).selectByVisibleText("Terms");
            Thread.sleep(3000);
            //X Axis Field fill
            new Select(driver.findElement(By.id("4fieldSelectID"))).selectByVisibleText("City");
            Thread.sleep(3000);
            //X arrow button close
            driver.findElement(By.id("4metricExpandButtonIID")).click();
        }
*/
    }
    ...
    public static void loginBIInValid(WebDriver driver, List<Records> listOb,String username,String password) throws Exception {
    ...
    public static void loginAdUserInWb(WebDriver driver, WebDriverWait wait,String user,List<Records> listOb) throws Exception {
        ...
        try {
            ...
            driver.findElement(By.cssSelector("div[class='view-inactive-users1']")).findElement(By.cssSelector("span[class='slider round']")).click();

            Thread.sleep(3000);
            List<WebElement> list=driver.findElement(By.cssSelector("table[id='userTable']")).findElements(By.cssSelector("tr[ng-repeat='user in allUsers | filter: searchItem']"));
            int size=list.size();
            ...
            for(int i=0;i<size;i++) {
                ...
                str=driver.findElement(By.cssSelector("td[data-title=\"'User Name'\"]")).getText().trim();

                System.out.println(str);

                if(user.equals(str)){
                    list1.get(0).findElement(By.cssSelector("span[class='checkmark']")).click();
                    break;
                }
                else{
                    continue;
            ...
            Thread.sleep(2000);
            driver.findElement(By.cssSelector("button[ng-click='activateAllSelectedUsers(1)']")).click();

            Thread.sleep(3000);

            driver.findElement(By.cssSelector("button[class='ajs-button ajs-ok']")).click();
            ...
            Thread.sleep(2000);
            value= SeleniumUtils.validateUser(driver);

            if(value.equals(true)){
                System.out.println("Normal User created and activated successfully!");
            }
            SeleniumUtils.clickLogout(driver);
    ...
    public static void loginBIValid(WebDriver driver, List<Records> listOb,String username, String password, String url) throws Exception {
        Records record = new Records();
        Boolean actualOutcome = false;
        ...
        try {
            ...
            try {
                driver.findElement(By.cssSelector("div[class='welcomeusertext']"));
                actualOutcome = true;
            } catch (Exception e) {
                actualOutcome = false;
                log.error("", e);
    ...
    public static void loginAdUser(WebDriver driver, List<Records> listOb,String user,String message,String message1,String url, String username, String password) throws Exception {
        ...
        try {
            ...
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            if(message1.equals("inactiveuser")) {
                ...
                try {
                    loginMessage = driver.findElement(By.cssSelector("span[name='invalidMCubeSpan']")).getText().trim();
                    System.out.println(loginMessage);

                    if (loginMessage.equals(message)) {
                        actualOutcome = true;
                    }
                } catch (Exception e) {
                    actualOutcome = false;
    ...
    public static boolean clickOkButton1(WebDriver driver,WebDriverWait wait,List<File> screenShot) throws Exception {
        ...
        try {
            ...
            int size=list.size();
            System.out.println("Size of JD Alert : "+size);
            for(int i=0;i<size;i++) {
                str=list.get(i).getText();
                System.out.println("STR of Modal button of JD: "+str);
                if (str.equalsIgnoreCase("OK")||str.equalsIgnoreCase("Add Dataset")) {
                    screenShot.add(SeleniumUtils.takeScreenShot(driver));
                    SeleniumUtils.clickModal(driver,list.get(i));
                    //list.get(i).click();
                    Thread.sleep(1000);
                }
                else{
    ...
    public static void clickExpandAll(WebDriver driver) throws Exception {

        Boolean actualOutcome = false;
        Actions actions = new Actions(driver);
        String str=null;
        String classValue="fa fa-angle-double-down";

        try {

            WebElement webElem = driver.findElement(By.cssSelector("div[class='col-sm-12 tree-rows tree-headers']"));
            Thread.sleep(1000);
            actions.moveToElement(webElem).perform();
            Thread.sleep(2000);
            driver.findElement(By.cssSelector("span[ng-show='showExpandBtn']")).click();

            List<WebElement> list = driver.findElement(By.cssSelector("span[ng-show='showExpandBtn']")).findElements(By.tagName("i"));
            int size=list.size();
            System.out.println(size);
            str = list.get(1).getAttribute("class").trim();

            if(str.equals(classValue)){
                actualOutcome = true;
                System.out.println(str);
            }
        }
    ...
    public static void validateUserInBI(WebDriver driver) throws Exception {

        Boolean actualOutcome = false;
        String str=null;
        try {

            List<WebElement> list=  driver.findElement(By.cssSelector("app-switcher[chrome='chrome']")).findElements(By.cssSelector("div[class='global-nav-link ']"));
            int size=list.size();

            for(int i=0;i<size;i++){

                str=  list.get(i).findElement(By.tagName("a")).findElement(By.cssSelector("div[class='global-nav-link__title']")).getText().trim();
                System.out.println(str);
                if(str.equals("Explore")||str.equals("Dashboard")||str.equals("Help")){
                    actualOutcome = true;
                }
                else{
                    actualOutcome = false;
    ...
    public static void clickLogout(WebDriver driver) throws Exception {
        ...
        try {
            ...
            driver.findElement(By.cssSelector("button[id='logout']")).click();

            Thread.sleep(3000);

            driver.findElement(By.cssSelector("button[class='ajs-button ajs-ok']")).click();
            //driver.close();
            SeleniumUtils.switchToWindow(0, driver,"navigate");
        } catch (Exception e) {
    ...
    public static boolean validateUser(WebDriver driver) throws Exception {
        ...
        for(int i=0;i<size;i++) {
            ...
            List<WebElement> list1 = list.get(i).findElements(By.tagName("td"));
            str=driver.findElement(By.cssSelector("td[data-title=\"'Is Admin'\"]")).getText().trim();

            if(str.equals("Normal User")){
                actualOutcome=true;
                break;
            }
            else{
    ...
    public static void switchToWindow(int index, WebDriver driver,String value) {
        ...
        if(value.equals("navigate")) {
            driver.switchTo().window(windowId);
            System.out.println("Switched to Window : " + windowId);
        }
        else{
            driver.close();
            System.out.println("Closed current Window : " + windowId);
        }
    }
    ...
    public static void changeDate(WebDriver driver, WebDriverWait wait, List<File> screenShot) throws Exception {
        ...
        try {
            ...
            Select yearDD = new Select(driver.findElement(By.xpath("//*[@id=\"template_wrapper\"]/kbn-timepicker/div/div[2]/div[1]/div[2]/div[2]/div/div/form/div[1]/div[2]/select")));
    ...
    public static void saveByName1(WebDriver driver, String saveName) {

        driver.findElement(By.xpath("//*[@id=\"template_wrapper\"]/form/input")).click();
        driver.findElement(By.cssSelector("div[id='KTNvisualizeSaveButtonLocalMenuID']")).click();
    ...
    public static void lastLogin(WebDriver driver,String usage) {
    ...
    public static void dbConnection(WebDriver driver,String database,int index,String connectionName, List<File> screenShot) {
        ...
        try {
          ...
          //  driver.findElement(By.cssSelector("input[id='DATABASE']")).sendKeys("gpadmin");
            ...
            Select databaseDropdown1 = new Select(driver.findElement(By.cssSelector("select[id='database']")));

         //   System.out.println("databaseDropdown: " + databaseDropdown1);

            databaseDropdown1.selectByVisibleText("gpadmin");

            Thread.sleep(2000);

            Select objectDropdown1 = new Select(driver.findElement(By.cssSelector("select[id='tables']")));

            objectDropdown1.selectByVisibleText("sales_all_details_12");
...
//        OutputStream out = new FileOutputStream((SrcFile));
    ...
    public static boolean verifyResult(WebDriver driver, String name, String expResult, Records rec, String className) {
        if (expResult.equalsIgnoreCase(name)) {
    ...
    public static void clickLogo(WebDriver driver, WebDriverWait wait, String name) {
        System.out.println(name + " is prepared, clicking on mcube logo");
        driver.findElement(By.cssSelector("div[class='global-nav__logo']")).click();
        System.out.println("Waiting for dashboard Filter on screen");
    ...
    public static boolean query(WebDriver driver, WebDriverWait wait, String index) {
    ...
    /*This function is used to select all the checkboxes while creating a new profile and it returns boolean value.*/
    ...
    public static boolean checkVersion(WebDriver driver, WebDriverWait wait, List<Records> listOb, String className, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            if(className.contains("4520") && version.equals("Version: 4.5.2.0"))
                ...
                actualOutcome=true;
            else if(className.contains("ADSanity4_3") && version.equals("Version: 4.3"))
                actualOutcome=true;
            else if(className.contains("Lummus4_3") && version.equals("Version: 4.3"))
                actualOutcome=true;
            else
                actualOutcome=false;
