package com.jdbc.automation.executor.lummus4300.AdvanceAnalytics;
...
public class ArtificialIntelligence {
    ...
    public static boolean artificialIntelligence(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            String connection= "Greenplum"+now.format(formatter);
        ...
        Thread.sleep(2000);*/
            ...
            SeleniumUtils.dbConnection(driver,"Greenplum",3,connection,screenShot);

            Thread.sleep(5000);

            SeleniumUtils.addReadNode(driver,wait,connection,screenShot);
