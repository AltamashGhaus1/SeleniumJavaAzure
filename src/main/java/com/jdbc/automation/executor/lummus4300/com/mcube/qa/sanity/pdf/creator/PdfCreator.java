package com.jdbc.automation.executor.lummus4300.com.mcube.qa.sanity.pdf.creator;
...
//            img.setAbsolutePosition(467,750);
            ...
            addScreenShotTableHeaader(screenShotsTable);
...
//            document.add(screenShotsTable);
    ...
    private static void addScreenShotTableHeaader(PdfPTable table){
