...
public class UserCreation {
    ...
    public static void userCreation(WebDriver driver, WebDriverWait wait, String role, List<Records> listOb) throws Exception {
        ...
        try {
            ...
            driver.findElement(By.xpath("//*[@id=\"tabs1\"]/div[6]/div/form/div/div[2]/input")).sendKeys("mcubeQA");
            driver.findElement(By.xpath("//*[@id=\"tabs1\"]/div[6]/div/form/div/div[3]/input")).sendKeys("mcubeqa@tcgdigital.com");
