...
//            chartX = chartX.replaceAll("[\\u00A0\\s]+", " ").trim();
//            chartX = chartX.trim();


            String rawHtml = chartMetrics.get(0).findElement(By.tagName("span")).getAttribute("innerHTML");
            chartX = HtmlCleaner.cleanHtml(rawHtml);
            chartX = chartX.trim();
            ...
            System.out.println("------------FOR r4 START-------------");
            System.out.println("lhsX :"+lhsX);
            System.out.println("chartX :"+chartX);
            System.out.println("------------FOR r4 END-------------");
    ...
    public static int noOfXFields(WebDriver driver){
        ...
        try {
//     WebDriver driver = DriverFactory.getWebDriver();
            System.out.println("Inside noOfXFields..");
...
//        WebDriver driver  = DriverFactory.getWebDriver()
    ...
    public static int noOfXStringFields(WebDriver driver) throws InterruptedException {

        int field_size = 0;

//        WebDriver driver = DriverFactory.getWebDriver();
        System.out.println("Inside noOfXStringFields..");
        Thread.sleep(3000);
        ...
        System.out.println("StringFields Size:"+size);
        for(int i = 0; i < size; i++) {
        ...
        System.out.println("First Field Size: "+stringFields.get(0).getText());
        System.out.println("Last Field Size: "+stringFields.get(field_size-1).getText());
        System.out.println("Field Size to be returned: "+field_size);
        return field_size;
    }
      ...
      Records record = new Records();
        ...
        try {
            ...
            try {
                ...
                System.out.println("Subbbmit is clicked for loginBIValid page");
            } catch (Exception e) {
                driver.findElement(By.xpath("//*[@name='submit']")).click();
                System.out.println("Inside submit catch : e : "+e);
            }
...
//        Thread.sleep(6000);
    ...
    public static void scrollByVisibleElement(WebDriver driver, WebElement webEl) {
        ...
        try {
            System.out.println("Inside try of scrollByVisibleElement");
            JavascriptExecutor js = (JavascriptExecutor) driver;
            js.executeScript("arguments[0].scrollIntoView();", webEl);
        } catch (Exception e) {
            System.out.println("Inside Catch scrollByVisibleElement for : "+webEl);
        }
    }
    ...
    public static boolean checkVersion(WebDriver driver, WebDriverWait wait, List<Records> listOb, String className,ClientVersionDao clientVersionDao,int san_aut_id) throws Exception {
        ...
        try {
            Navbar.waitForPageLoad(driver);
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='version']")));
            String version = driver.findElement(By.xpath("//div[@class='version']")).getText().trim();
            System.out.println("Version name : "+version);
            screenShot.add(SeleniumUtils.takeScreenShot(driver));

            if(className.contains("510") || version.equals("tcgmcube 5.1") || version.equals("tcgmcube 5.1.1") || version.equals("tcgmcube 5.2"))
                actualOutcome=true;
...
//    }
    ...
    public static boolean validateapplication(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id ) throws Exception {
        ...
        try {
            System.out.println("Inside validateapplication..");
...
//            WebElement app = driver.findElement(By.cssSelector("div[class='card-title']"));
            WebElement app = driver.findElement(By.xpath("//div[@class='card-title small-app-title']"));
            String as = app.getText();
...
//            List<WebElement> app = driver.findElements(By.cssSelector("p[class='card-text']"));
            List<WebElement> app = driver.findElements(By.xpath("//div[@class='card-title small-app-title']"));
...
//            System.out.println(hexcolor);
    ...
    public static boolean validatetilesisenabledAfterWS_Switch(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) {
        ...
        try {
            ...
            switchWorkspace(driver,"mcube_ws");
