...
import static com.jdbc.automation.executor.Common.Navbar_buttons.backToHome;
import static com.jdbc.automation.executor.Common.Records.actualOutcome;

public class SeleniumUtils_Anshu {
...
//        WebDriver driver = DriverFactory.getWebDriver()
        ...
        try {
            ...
            System.out.println("spyLabels----" + spyLabels);


            // Left header of Spy Mode example : Region or State/Province
//            spyX = spyLabels.get(0).findElement(By.tagName("thead")).getAttribute("textContent");
            spyX = spyLabels.get(0).findElement(By.tagName("span")).getAttribute("textContent");

            spyX = spyX.trim();//unitprices ranges
...
//            Thread.sleep(300000000);
            ...
            System.out.println("chartMetrics----" + chartMetrics);
//
            Thread.sleep(3000);

            System.out.println("AG get chartMetrics.get(0) = "+chartMetrics.get(0));

//            chartX = chartMetrics.get(0).findElement(By.tagName("span")).getText();
            chartX = chartMetrics.get(0).findElement(By.tagName("span")).getAttribute("innerHTML");
            chartX = chartX.trim();

            // WebElement   chartXvalue= driver.findElement(By.xpath("(//div[@class='col-sm-8'])[1]//span"));
            //chartX = chartMetrics.get(0).getAttribute("textContent");
            //chartX=chartXvalue.getText().trim();
            // chartX = chartMetrics.get(0).findElement(By.tagName("span")).getText();
            // chartX = chartXvalue.getText();

            System.out.println("This is chartX  new scheccKk value : " + chartX);//blank aa rha
            ...
            System.out.println(" This is chartY value : " + chartY);
            ...
            System.out.println( lhsX.equals(chartX));
...
//
        ...
        int size = fields.size();
        System.out.println("Size of y fields : " + size);
...
//        System.out.println("Terms region selected");
//    }
    ...
    public static void xDataFillTree(WebDriver driver, WebDriverWait wait) throws InterruptedException {
        ...
        for(int i=13;i<=14;i++) {
            ...
            System.out.println("str valu" + str);


            if (str.equalsIgnoreCase("Split Rows")) {
                list.get(1).click();
                System.out.println("click o ra hai");


                driver.findElement(By.xpath("//select[@id='12bucketSelectButtonID']")).click();
                //X Axis click
                new Select(driver.findElement(By.xpath("//select[@id='12bucketSelectButtonID']"))).selectByVisibleText("Terms");
                Thread.sleep(3000);
                System.out.println("Terms selected");

                //X Axis Field fill
                if (i == 13) {
                    new Select(driver.findElement(By.xpath("//select[@id='12fieldSelectID']"))).selectByVisibleText("Region");
                    Thread.sleep(3000);
                ...
                //X arrow button close
                new Select(driver.findElement(By.id("12fieldSelectID"))).selectByVisibleText("City");
                Thread.sleep(3000);
                // driver.findElement(By.id( "metricExpandButtonIID")).click();
                driver.findElement(By.xpath("//*[@id=\"SBIID\"]")).click();
...
//        OutputStream out = new FileOutputStream((SrcFile));
    ...
    public static boolean verifyResult(WebDriver driver, String name, String expResult, Records rec, String className)
    {
        ...
        return expResult.contains(name);
    }
...
//        WebDriver driver = DriverFactory.getWebDriver()
        ...
        try {
            ...
            List<WebElement> chartData = (List<WebElement>) driver.findElement(By.cssSelector("g[class='c3-chart']")).findElement(By.cssSelector("g[class='c3-chart-texts']")).findElement(By.tagName("text"));
//            List<WebElement> chartData = driver.findElement(By.cssSelector("g[class='c3-chart']")).findElement(By.cssSelector("g[class='c3-chart-texts']")).findElements(By.cssSelector("g[class='c3-chart-text c3-target c3-target-Average-Cost-per-ID']").findElement(By.cssSelector("g[class='c3-texts c3-texts-Average-Cost-per-ID']").findElement(By.tagName("text"));

//            List<WebElement> chartData = (List<WebElement>) driver.findElement(By.cssSelector("g[class='c3-chart']")).findElement(By.cssSelector("g[class='c3-chart-texts']")).findElement(By.cssSelector("g[class='c3-chart-text c3-target c3-target-Average-Cost-per-ID']"));
            //-----------------
...
//            for(int i = 1; i < s; i++) {
            for(int i = 0; i < s; i++) {
                ...
                String str=list.get(i).findElement(By.tagName("text")).getText();
                int len=str.length();
...
//    }
    ...
    //Anshu Validation
    public static boolean validateapplication(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id ) throws Exception {
        ...
        try {
            ...
            WebElement app = driver.findElement(By.xpath("//h2[normalize-space()='Applications']"));
            String as = app.getText();
            if(as.equals("Applications")) {
                System.out.println("Application text is present on the left side of the page: ");
                screenShot.add(SeleniumUtils.takeScreenShot(driver));
                actualOutcome=true;
            } else {
            ...
            record.setTestCaseName("SAN-LOGIN-02");
            record.setOutcome(actualOutcome);
            record.setName("APPLICATIONS PRESENT");
            record.setScreenShot(screenShot);
            record.setExpectedResult("APPLICATIONS TILES PRESENT");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return isValid;
    }
    public static boolean validateAllTiles(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) {
...
//        WebDriver driver  = DriverFactory.getWebDriver()
        ...
        try {
            ...
            WebElement app = driver.findElement(By.cssSelector("div[class='card-title']"));
            String as = app.getText();
            if (as.equals("Business Intelligence")||as.equals("Artificial Intelligence")||as.equals("ezeXtend")||as.equals("Workbench")) {

                System.out.println("All the tiles are present on the landing page ");
                actualOutcome = true;
            }
            else {
                System.out.println("Not present--------> TEST CASE IS FAILED");
                actualOutcome = false;
            }   //end of inner if-else
        }    //end of outer if
        //end of for loop
        //end of try block
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-TILES-01");
            record.setOutcome(actualOutcome);
            record.setName("ALL TILES PRESENT");
            record.setScreenShot(screenShot);
            record.setExpectedResult("BI/AI/WB/EZEXTEND TILES PRESENT");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
    }// end of method
    public static boolean validateAllTextPresent(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
...
//        WebDriver driver  = DriverFactory.getWebDriver()
        ...
        try {
            ...
            List<WebElement> app = driver.findElements(By.cssSelector("p[class='card-text']"));
            String bi = app.get(0).getText();
            String ai = app.get(1).getText();
            String ez = app.get(2).getText();
            String wb = app.get(3).getText();

            if (bi.equals("Self-service dashboarding, real-time operational reporting and scheduled distribution.")&&ai.equals("No-code and code-based AI and ML analysis, model training and deployment.")||ez.equals("Low-code development environment to design, edit and manage analytical application")||wb.equals("Administration, user management, authorization, platform monitoring, data management and development tools.")) {

                System.out.println("All text present in each tiles  ");
                screenShot.add(SeleniumUtils.takeScreenShot(driver));
                actualOutcome = true;
            }
        ...
        //end of try block
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-DESC-01");
            record.setOutcome(actualOutcome);
            record.setName("TILES DESCRIPTION");
            record.setScreenShot(screenShot);
            record.setExpectedResult("TILES DESCRIPTION CORRECT");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
    }// end of method
    public static boolean validateBoldColor(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
...
//        WebDriver driver  = DriverFactory.getWebDriver()
        ...
        try {
            ...
            WebElement app = driver.findElement(By.cssSelector("div[class='card-title']"));
//code for color code conversion
//            String colorCode= app.getCssValue("color");
//
//            System.out.println("Color code in RGB" + colorCode);
//
//            String hexcolor = Color.fromString(colorCode).asHex();
//            System.out.println(hexcolor);
            String font_wt = app.getCssValue("font-weight");
            System.out.println("Bold-Font: " +font_wt);{

                if(font_wt.equals("700")){
        ...
        //end of try block
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-BOLD-01");
            record.setOutcome(actualOutcome);
            record.setName("BOLD TEXT");
            record.setScreenShot(screenShot);
            record.setExpectedResult("BOLD TEXT VALIDATIONS IN TILES");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
    ...
    public static boolean validatetilesisenabledAfterWS_Switch(WebDriver driver, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) {
        ...
        try {
            ...
            WebElement app = driver.findElement(By.xpath("//input[@placeholder='Search Workspace']"));

            switchWorkspace(driver,"koyel_test");

            //if (driver.findElement(By.xpath("(//div[normalize-space()='ezeXtend'])[1]")).isEnabled()) ;

            Thread.sleep(2000);

            //driver.findElement(By.xpath("((//div[normalize-space()='Artificial Intelligence'])[1]")).isDisplayed();

            if (driver.findElement(By.xpath("(//div[normalize-space()='ezeXtend'])[1]")).isEnabled()) {
                Thread.sleep(4000);
                System.out.println("ezeXtend is enabled");
                screenShot.add(SeleniumUtils.takeScreenShot(driver));
                actualOutcome  = true;
            }
            else {
                screenShot.add(SeleniumUtils.takeScreenShot(driver));
                System.out.println("ezeXtend is not enabled");
                actualOutcome  = false;
            }   //end of inner if-else

            Thread.sleep(3000);
            System.out.println("About to switch to Default WS");
            switchWorkspace(driver,"Default_group");
            System.out.println("Switched to Default WS DONE");
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-TILE-ENABLED-01");
            record.setOutcome(actualOutcome);
            record.setName("TILES ENABLED");
            record.setScreenShot(screenShot);
            record.setExpectedResult("TILES ENABLED CHECKED");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
    ...
    private static void switchWorkspace(WebDriver driver, String switchWorkspace) throws InterruptedException {
        Navbar.waitForPageLoad(driver);

        try {
            driver.findElement(By.xpath("//span[@class='mat-mdc-tooltip-trigger default-workspace dropdown-toggle']")).click();

            System.out.println("dropdown is clicked");
            Thread.sleep(2000);
            driver.findElement(By.xpath("//input[@placeholder='Search Workspace']")).sendKeys(switchWorkspace);
            driver.findElement(By.xpath("//span[@class='mat-mdc-tooltip-trigger ws-names']")).click();
            System.out.println("workspace is switched");
            Navbar.waitForPageLoad(driver);
        } catch (InterruptedException e) {
            System.out.println("Switch WS : "+e);
            Navbar.waitForPageLoad(driver);
        }
    }

    public static boolean validatedisablesTilesMessage(WebDriver driver,WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) {
...
//            driver.findElement(By.xpath("//span[@class='mat-mdc-tooltip-trigger default-workspace dropdown-toggle']")).click();
//
//            System.out.println("dropdown is clicked2");
//            Thread.sleep(2000);
//
//            driver.findElement(By.xpath("//input[@placeholder='Search Workspace']")).sendKeys("koyel_test");
//            driver.findElement(By.xpath("//span[@class='mat-mdc-tooltip-trigger ws-names']")).click();
//            Thread.sleep(2000);
            WebElement element=  driver.findElement(By.xpath("(//div[contains(@class,'card text-center')])[2]"))  ;

            Actions toolAct = new Actions(driver);
            toolAct.moveToElement(element).build().perform();

            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[contains(@class,'card text-center')])[2]//div[contains(@class,'not-allowed')]")));

            WebElement text =driver.findElement(By.xpath("(//div[contains(@class,'card text-center')])[2]//div[contains(@class,'not-allowed')]"));
            //driver.findElement(By.xpath("((//div[normalize-space()='Artificial Intelligence'])[1]")).isDisplayed();
            String msgText = text.getText();
            System.out.println("Msg Text: "+msgText);
            System.out.println(" AI tile is disabled");
            Thread.sleep(4000);
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            actualOutcome = true;
            //driver.findElement(By.className("//div[normalize-space()='Artificial Intelligence'])[1]")).getText();
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-TILE_DISABLED-01");
            record.setOutcome(actualOutcome);
            record.setName("TILE DISABLED");
            record.setScreenShot(screenShot);
            record.setExpectedResult("TILE DISABLED MSG CHECKED");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
    ...
    public static boolean validateTilesisClickable(WebDriver driver,WebDriverWait wait,String username,List<Records> listOb,ClientVersionDao clientVersionDao,int san_aut_id) {
        ...
        try {
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            Navbar.navbar(driver,wait,username,listOb,clientVersionDao,san_aut_id,"Landing");
            backToHome(driver, "Landing",listOb, clientVersionDao, san_aut_id);

            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            Navbar.tilesButton(driver,"BI");
            Navbar.navbar(driver,wait,username,listOb,clientVersionDao,san_aut_id,"BI");
            backToHome(driver, "BI",listOb, clientVersionDao, san_aut_id);

            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            Navbar.tilesButton(driver,"AI");
            Navbar.navbar(driver,wait,username,listOb,clientVersionDao,san_aut_id,"AI");
            backToHome(driver, "AI",listOb, clientVersionDao, san_aut_id);


            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            Navbar.tilesButton(driver,"ezeXtend");
            Navbar.navbar(driver,wait,username,listOb,clientVersionDao,san_aut_id,"ezeXtend");
            backToHome(driver, "ezeXtend",listOb, clientVersionDao, san_aut_id);

            screenShot.add(SeleniumUtils.takeScreenShot(driver));
            Navbar.tilesButton(driver,"Workbench");
            Navbar.navbar(driver,wait,username,listOb,clientVersionDao,san_aut_id,"Workbench");
            backToHome(driver, "Workbench",listOb, clientVersionDao, san_aut_id);
            ...
            Records.setSan_aut_id(san_aut_id);
            record.setTestCaseName("SAN-TILES-CLICKABLE-01");
            record.setOutcome(actualOutcome);
            record.setName("TILES CLICKABLE");
            record.setScreenShot(screenShot);
            record.setExpectedResult("ALL TILES ARE CLICKABLE");
            clientVersionDao.setRecordDetails(record);
            listOb.add(record);
        }
        return actualOutcome;
