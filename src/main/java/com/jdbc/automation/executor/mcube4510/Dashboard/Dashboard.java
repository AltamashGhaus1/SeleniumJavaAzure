package com.jdbc.automation.executor.mcube4510.Dashboard;
...
import static com.jdbc.automation.executor.mcube4510.Common.SeleniumUtils.firstWord;
...
public class Dashboard {
    ...
    public static boolean dashboard(WebDriver driver, WebDriverWait wait, List<String> widgetList, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            screenShot.add(com.jdbc.automation.executor.mcube4520.Common.SeleniumUtils.takeScreenShot(driver));
            actualOutcome = false;
            log.error("",e);
        }
        finally{
