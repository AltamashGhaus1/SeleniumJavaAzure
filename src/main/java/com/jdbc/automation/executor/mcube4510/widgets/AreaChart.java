package com.jdbc.automation.executor.mcube4510.widgets;
    ...
    public static String areaChart(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
       ...
       // Boolean actualOutcome = false;
        ...
        try {
            ...
            screenShot.add(com.jdbc.automation.executor.mcube4510.Common.SeleniumUtils.takeScreenShot(driver));
            actualOutcome = false;
            ...
            com.jdbc.automation.executor.mcube4510.Common.SeleniumUtils.clickModal(driver, webEl);
            Thread.sleep(2000);
            log.error("",e);
        }
