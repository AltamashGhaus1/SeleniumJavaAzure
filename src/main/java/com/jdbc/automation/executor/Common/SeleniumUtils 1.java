...
//        return sFlag;
//    }  //end of method
//    public static boolean validateapplication(WebDriver driver) {
//
...
//      return isValid;
//    }
//    public static boolean validateAllTiles(WebDriver driver) {
//
//        boolean    sFlag  = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
...
//        return sFlag;
//    }// end of method
//    public static boolean validateAllTextPresent(WebDriver driver) {
//
//        boolean    sFlag  = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
//        try {
//
//            WebElement app = driver.findElement(By.cssSelector("p[class='card-text']"));
//            String as = app.getText();
//            if (as.equals("Self-service dashboarding, real-time operational reporting and scheduled distribution.")||as.equals("No-code and code-based AI and ML analysis, model training and deployment.")||as.equals("Low-code development environment to design, edit and manage analytical application")||as.equals("Administration, user management, authorization, platform monitoring, data management and development tools.")) {
//
...
//        return sFlag;
//    }// end of method
//    public static boolean validateBoldColor(WebDriver driver) {
//
//        boolean    sFlag  = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
...
//    }// end of method
//
//    public static boolean validatetilesisenabled(WebDriver driver) {
//
//        boolean    sFlag  = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
...
//    }// end of method
//
//    public static boolean validatedisablesTilesMessage(WebDriver driver,WebDriverWait wait) {
//
//        boolean    sFlag  = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
...
//            System.out.println(" AI tiles is disabled");
//            Thread.sleep(2000);
...
//    }// end of method
//
//    public static boolean validateTilesisClickable(WebDriver driver) {
//
//        boolean isValid = true;
////        WebDriver driver  = DriverFactory.getWebDriver()
//
...
//            Thread.sleep(5000);
//            System.out.println("Bi is clicked");
