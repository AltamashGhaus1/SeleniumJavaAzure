package com.jdbc.automation.executor.ad4300.Common;
...
//        OutputStream out = new FileOutputStream((SrcFile));
    ...
    public static void clickLogo(WebDriver driver, WebDriverWait wait, String name) {
        ...
        wait.until((ExpectedConditions.visibilityOfElementLocated(By.id("SOFDashboardsID"))));
    }
    ...
    public static boolean checkVersion(WebDriver driver, WebDriverWait wait, List<Records> listOb, String className, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            if(className.contains("4520") && version.equals("Version: 4.5.2.0"))
                ...
                actualOutcome=true;
            else actualOutcome= className.contains("ADSanity4_3") && version.equals("Version: 4.3");
