package com.jdbc.automation.executor.ad4300.widgets;
...
public class ComboChart {
    ...
    public static String comboChart(WebDriver driver, WebDriverWait wait, List<Records> listOb, ClientVersionDao clientVersionDao, int san_aut_id) throws Exception {
        ...
        try {
            ...
            SeleniumUtils.xDataFill(driver, wait, "Combo");
            screenShot.add(SeleniumUtils.takeScreenShot(driver));
         ...
         */
            ...
            //------------------------------------
            String expResult = driver.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/visualize-app/kbn-top-nav/div/div/div/div[1]/div[1]/ol/li[4]/a")).getText().trim();
            ...
            screenShot.add(com.jdbc.automation.executor.ad4300.Common.SeleniumUtils.takeScreenShot(driver));
            actualOutcome = false;
            ...
            com.jdbc.automation.executor.ad4300.Common.SeleniumUtils.clickModal(driver, webEl);
            Thread.sleep(2000);
            log.error("",e);
        }
        finally {
