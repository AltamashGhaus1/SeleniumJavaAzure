package com.jdbc.automation.executor.ad4300.com.mcube.qa.sanity;

import com.jdbc.automation.executor.Common.Records;
import com.jdbc.automation.executor.ad4300.AdvanceAnalytics.ArtificialIntelligence;
import com.jdbc.automation.executor.ad4300.Common.SeleniumUtils;
import com.jdbc.automation.executor.ad4300.Dashboard.Dashboard;
import com.jdbc.automation.executor.ad4300.Explore.SavedSearch;
import com.jdbc.automation.executor.ad4300.Miscellaneous.DataProfile;
import com.jdbc.automation.executor.ad4300.Miscellaneous.DataUpload;
import com.jdbc.automation.executor.ad4300.Miscellaneous.SavedObjects;
import com.jdbc.automation.executor.ad4300.Workbench.ManagementPresteps;
import com.jdbc.automation.executor.ad4300.Workbench.RoleCreation;
import com.jdbc.automation.executor.ad4300.Workbench.WorkSpaceCreation;
import com.jdbc.automation.executor.ad4300.com.mcube.qa.sanity.email.EmailSender;
import com.jdbc.automation.executor.ad4300.com.mcube.qa.sanity.pdf.creator.PdfCreator;
import com.jdbc.automation.executor.ad4300.widgets.AreaChart;
import com.jdbc.automation.executor.ad4300.widgets.ComboChart;
import com.jdbc.automation.executor.ad4300.widgets.PreStepsForWidget;
import com.jdbc.automation.executor.ad4300.widgets.TreeTable;
...
public class ADSanity4_3 {

    private static final Logger log= LoggerFactory.getLogger(ADSanity4_3.class);
...
// --------------------------------- Check Version Start-------------------------------------------------------------------
            ADSanity4_3 obj = new ADSanity4_3();
...
//------------------------------------ SavedSearch End------------------------------------------------------------------
// --------------------------------- Dashboard Start--------------------------------------------------------------------
            int flag = com.jdbc.automation.executor.ad4300.Common.SeleniumUtils.checkNull(widgetList);
            if(flag==1)
...
//------------------------------------ Join Dataset Start---------------------------------------------------------------
            ...
            //JoinDataset.joinDataset(driver, wait, listOb,clientVersionDao,san_aut_id);
...
// --------------------------------- Workspace Start--------------------------------------------------------------------
            ...
            //ManagementPresteps.managementPresteps(driver,wait,listOb);
